...
export class GameStateSchema extends Schema {
  ...
  declare successfulHands: number;
  declare failedHands: number;
  declare targetSuccesses: number;
  declare maxFailures: number;
...
type('string')(GameStateSchema.prototype, 'campaignStatus');
type('number')(GameStateSchema.prototype, 'successfulHands');
type('number')(GameStateSchema.prototype, 'failedHands');
type('number')(GameStateSchema.prototype, 'targetSuccesses');
type('number')(GameStateSchema.prototype, 'maxFailures');
